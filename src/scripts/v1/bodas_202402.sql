...
CREATE TABLE `hijos` (
  ...
  `menu_especial_tipo` enum('vegetariano','gluten','otro') DEFAULT NULL,
...
CREATE TABLE `invitados` (
  ...
  `menu_principal_tipo_especial` enum('vegetariano','gluten','otro') DEFAULT NULL,
  ...
  `menu_acompanante_tipo_especial` enum('vegetariano','gluten','otro') DEFAULT NULL,
